...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-gradient-to-br from-white to-dev-gray">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-3xl">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-gray-700 mb-6 typewriter">
            Frontend Developer
          </h2>
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <Button variant="outline" className="border-dev-blue text-dev-blue hover:bg-dev-blue/10 px-6 py-2">
      ...
      <a 
        href="#about" 
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-dev-blue hover:text-dev-darkblue transition-colors animation-bounce"
      >
